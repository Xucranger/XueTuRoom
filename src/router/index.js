...
const routes = [
  ...
  },
  {
    ...
    children:[
      ...
      {
        path:'/admin/article/upload/messagefirst',
        name:'messagefirst',
        component:() => import('../admin/messagefirst.vue')
      },
      {
        path:'/admin/article/upload/messagesecond',
        name:'messagesecond',
        component:() => import('../admin/messagesecond.vue')
      },
      {
      ...
      {
        path:'/admin/article/upload/music',
        name:'music',
        component:() => import ('../admin/music.vue')
      },
      {
