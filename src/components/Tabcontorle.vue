<template>
      <div :class="{show:$store.state.isshow}" class="MeunTab">
              <div class="profile">
                <img width="100" height="100" src="../assets/images/me.jpg" alt="">
                <div class="profile">XUETU</div>
            </div>
      <List style="padding-left:1.5rem;">
            <ListItem>
              <i class="iconfont icon-qq">: 1275244661,</i>
              <i class="iconfont icon-weixin">: x1275244661</i>
              </ListItem>
            <ListItem>
...
<script>
  ...
  export default {
    ...
    methods: {
        ...
        Gogithub() {
          location.href='https://github.com/Xucranger'
        }
    },
  }
...
<style lang="scss" scoped>
    .MeunTab {
      width:23rem;
      height: 100vh;
      background: url('../assets/images/tabbg.png') no-repeat center;
