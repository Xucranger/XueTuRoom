<template>
  <div id="center">
        <div class="wrapper">
            ...
            <div class="text">
                <div class="text--backing">XUETU</div>
                <div class="text--left">
                    <div class="inner">XUETU</div>
                </div>
    ...
    data () {
      return {
        navgation: [
            ...
            { name:' Github',icon:'iconfont icon-GitHub', path:'https://github.com/Xucranger' },
        ]
      };
    },
    methods: {
        triggerPage(path) {
            if(path === 'https://github.com/Xucranger') {
                window.open(path)
            } else {
